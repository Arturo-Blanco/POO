...
var client1 = new clientClass_1.Client('Juan', 'Perez', 38754826, 'Velez Sarfield', authors, genres, 0.1);
var client2 = new clientClass_1.Client('Hernan', 'Rodriguez', 58746216, 'Nuñez', authors, genres, 0.3);
var book1 = new bookClass_1.Book('Campanita', 50, 'Pedro', 200, 'Este libro habla sobre la historia de un hada..', 'Fantasia');
var book2 = new bookClass_1.Book('Iron man', 150, 'Juan', 300, 'Este libro trata de un multimillonario que se hace superheroe', 'Drama');
