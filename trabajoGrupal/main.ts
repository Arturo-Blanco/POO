...
let pregunta1:Pregunta=new Pregunta('Cuanto es 2+2',opcPreg1,2,2);
let pregunta2:Pregunta=new Pregunta('Cuanto es 4*3',opcPreg2,2,2);
let pregunta3:Pregunta=new Pregunta('Cuanto es 100 + 100',opcPreg3,1,2);
let preguntas:Pregunta[]=[pregunta1,pregunta2,pregunta3];

let examen1:Examen=new Examen(preguntas,'Matematicas',6);
let respuestasExamen=[2,2,1];
